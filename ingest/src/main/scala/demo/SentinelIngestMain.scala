...
/*object SentinelIngestMain extends App {
  ...
  val attributeStore = FileAttributeStore("/home/kkaralas/Documents/vboxshare/t34tel")

  val writer = FileLayerWriter(attributeStore) // CassandraLayerWriter(instance, keyspace, dataTable)
